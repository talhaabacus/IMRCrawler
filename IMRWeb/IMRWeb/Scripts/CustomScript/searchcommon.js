...
function onDetailSuccess(data, status, jqXHR) {
    ...
    if (formatID == 1) {
        ...
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">How the IMR Final Determination was made</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.HowIMRDetermination + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Clinical Case Summary</label><textarea rows="6" class="form-control"  readonly >' + data.pdfDetail.ClinicalCaseSummary + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Diagnosis</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.Diagnosis + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">IMR Issues, Decisions and Rationales</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.IMRIssuesRationales + '</textarea></div>';
        ...
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">How the IMR Final Determination was made</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.HowIMRDetermination + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Clinical Case Summary</label><textarea rows="6" class="form-control"  readonly >' + data.pdfDetail.ClinicalCaseSummary + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Documents Reviewed</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.DocumentsReviewed + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">IMR Issues, Decisions and Rationales</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.IMRIssuesRationales + '</textarea></div>';
        ...
        boxdiv = boxdiv + '<div class="form-group"><label for="txtAge" class="control-label">Age</label><input type="text" class="form-control" id="txtAge"  readonly value="' + data.pdfDetail.Age + '"></div>';
        boxdiv = boxdiv + '<div class="form-group"><label for="txtGender" class="control-label">Gender</label><input type="text" class="form-control" id="txtGender"  readonly value="' + data.pdfDetail.Gender + '"></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Issue At Dispute</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.IssueAtDispute + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Case Summary</label><textarea rows="6" class="form-control"  readonly >' + data.pdfDetail.ClinicalCaseSummary + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Diagnosis</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.Diagnosis + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Documents Reviewed</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.DocumentsReviewed + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Medical Treatment Guideline(s)  Relied Upon By Professional Reviewer and Why</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.TreatmentGuidelines + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Rationale For Why the Requested Treatment/Service Is/Was Not Medically Necessary</label><textarea rows="6" class="form-control" readonly >' + data.pdfDetail.IMRIssuesRationales + '</textarea></div>';
        boxdiv = boxdiv + '<div class="form-group"><label class="control-label">Medical Reviewer Qualifications</label><textarea rows="6" class="form-control"readonly >' + data.pdfDetail.ReviewerQualifications + '</textarea></div>';
